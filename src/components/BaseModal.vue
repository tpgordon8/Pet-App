        ...
        >
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <button
              v-if="showClose"
              type="button"
              class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors motion-reduce:transition-none p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
