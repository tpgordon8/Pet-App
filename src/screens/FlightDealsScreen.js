// Flight Deals Screen - Luxe Vacation Design
// Main screen for browsing amazing flight deals
...
import { DEFAULT_AIRPORT } from '../constants/airports';
import { getMockDealsWithDelay } from '../services/mockFlightData';
import { searchFlightDeals, hasCredentials } from '../services/flightApi';
import {
  saveDeal,
  removeSavedDeal,
  subscribeSavedDeals,
...
export default FlightDealsScreen;
