...
These guidelines reduce common LLM coding mistakes and improve code quality and clarity.
...
For multi-step tasks, state a brief plan with verification checkpoints before implementation.
